...
# Input validation for blades, take input from user
while true; do
	echo "How many blades are on the IAD? [1-4] "
	read blade
	if [[ $blade =~ ^[1-4]+$ ]]; then
		break
	fi
...
# Input validation for vertials, take input from user
while true; do
...
# Input validation for pair, take input from user
while true; do
...
# Input validation for IAD, take input from user
while true; do
